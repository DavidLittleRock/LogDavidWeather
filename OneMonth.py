...
#        'y4_legend': f"Rain 24 hours {rain_total_24[-1]:.1f} inch",
    ...
    pyplot.savefig('/var/www/html/TempHeatIndexSevenDayGraph2.png')
    show_fig(fig)
...
def show_fig(fig):
    ...
    pyplot.pause(60)
    pyplot.clf()
    pyplot.close(fig=101)


def make_fig(time_now, lrtime):
    figure = pyplot.figure(num=101, facecolor='green')  # scope of figure is make_fig()
